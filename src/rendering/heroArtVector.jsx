...
const HERO_INFO = {
  ...
  pilgrim:    { name:'The Ashen Pilgrim',        sub:'A long walk. The wrong shrine.',                  tags:['Wide-brim hat','Travel coat','Lantern staff'],  stats:{ATK:3,DEF:5,DEX:5,TORCH:8,HP:36}, spell:{name:'Sanctuary',       cd:8, ar:3,      color:'#d4be7a', desc:'Heal and reveal nearby ground.'} },
  warden:     { name:'The Tower Warden',         sub:'They built the gate. He stayed when it failed.',  tags:['Tower shield','Heavy plate','Unbroken'],        stats:{ATK:3,DEF:7,DEX:1,TORCH:4,HP:40}, spell:{name:'Iron Stand',      cd:8,            color:'#bcd6ff', desc:'Iron Skin, purge poison, slow nearby foes.'} },
