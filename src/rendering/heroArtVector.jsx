...
const HERO_INFO = {
  ...
  pilgrim:    { name:'The Ashen Pilgrim',        sub:'A long walk. One wrong turn.',                    tags:['Wide-brim hat','Travel coat','Lantern staff'],  stats:{ATK:3,DEF:5,DEX:5,TORCH:8,HP:36}, spell:{name:'Sanctuary',       cd:8, ar:3,      color:'#d4be7a', desc:'Heal and reveal nearby ground.'} },
